...
const fetch_searchMusicByPlaylist = async (query: string, token: string) => {
  const res = await fetch("api/searchMusicByPlaylist", {
    method: "POST",
    headers: {
      "Content-Type": "application/json"
    },
...
export { fetch_doClientCredentials, judgeStatus, fetch_searchMusicSimple, fetch_searchMusicAdvanced, fetch_searchMusicByPlaylist };